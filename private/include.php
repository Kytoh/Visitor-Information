...
$inc_path = dirname( __FILE__ ).'/private';
...
spl_autoload_register(function($class_name) {
	...
	$dirs = array(
			$base_path.'/private/funct/', // Project specific classes (+Core Overrides)
			$base_path.'/private/class/', // Core classes example
	);
	...
	foreach( $dirs as $dir ) {
		if (file_exists($dir.'class.'.strtolower($class_name).'.php')) {
			require($dir.'class.'.strtolower($class_name).'.php');
			return;
		}
	}
});
